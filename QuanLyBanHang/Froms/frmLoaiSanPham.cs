...
namespace QuanLyBanHang.Froms
{
    public partial class frmLoaiSanPham : Form
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(lbTenLoai.Text))
        ...
        private void frmLoaiSanPham_Load(object sender, EventArgs e)
        {
            ...
            lbTenLoai.DataBindings.Clear();
            lbTenLoai.DataBindings.Add("Text", bindingSource, "TenLoai", false, DataSourceUpdateMode.Never);
